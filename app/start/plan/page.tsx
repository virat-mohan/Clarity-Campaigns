  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div className="mb-6 border-b border-border pb-4">
        <div className="font-mono-label text-[10px] text-primary mb-1">Your plan</div>
      ...
      <div className="flex flex-col gap-4">
        <div>
          <div className="font-mono-label text-[9.5px] text-muted-foreground mb-3">Sprint timeline</div>
          <PlanTimeline steps={planDetails.weeklyProcess} />
        </div>

        <div>
          <div className="font-mono-label text-[9.5px] text-muted-foreground mb-3">Human Pod</div>
        ...
        <div>
          <div className="font-mono-label text-[9.5px] text-muted-foreground mb-3">Expected results</div>
          <Card>
            <CardContent className="pt-5">
              <div className="mb-3 flex flex-wrap items-center gap-2">
                {copy.goalLine.split(", ").map((metric) => (
                  <span key={metric} className="font-mono text-[10px] px-2 py-1 rounded-full bg-primary/10 text-primary border border-primary/30">
                    {metric}
                  </span>
                ))}
              </div>
              <p className="text-[13px] text-foreground leading-relaxed">{kpiText}</p>
              <p className="mt-3 text-[10.5px] text-muted-foreground-2">
                Based on {industryLabel ?? "your"} benchmarks for {marketLabel ?? "your"} market. Actual results vary.
              </p>
            </CardContent>
          </Card>
        </div>
